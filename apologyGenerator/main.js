...
var outputLetterSpacingRange = document.getElementById(
  "letterSpacingRangeValue"
);
...
//Текст повышенного кегля
$("#largerSizeFont").on("click", function () {
  textAreaInput.value += "<aside>Текст повышенного кегля</aside>";
  textAreaInputValue = textAreaInput.value;
  textAreaOutput.innerHTML = textAreaInputValue;
});
//Текст повышенного кегля//
